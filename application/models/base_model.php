...
class base_model extends CI_Model {
	...
	function getButton() {
		...
		$str .= '<a class="btn btn-primary" href="'.base_url().'dang-nhap.html?r='.$redirectUrl.'">ÄÄƒng nháº­p</a> ';
		$str .= '<a class="btn btn-primary" href="'.base_url().'dang-ky.html">ÄÄƒng kÃ½ thÃ nh viÃªn</a> ';
		$str .= '<a class="btn btn-primary" href="'.base_url().'dich-vu.html">ÄÄƒng kÃ½ dá»‹ch vá»¥</a>';
		$str .= '</div>';
		return $str;
	}
