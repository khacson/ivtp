 ...
 * @copyright 2015
 */
class Investmentcatalog extends CI_Controller {
    ...
    function deletes() {
        ...
        $array['isdelete'] = 1;
        $this->model->table('ivt_investmentcatalog')->where('id',$id)->delete();
    ...
    function resizeImg($image_data) {
        ...
        $configz['source_image'] = './files/investmentcatalog/' . $image_data;
        $configz['new_image'] = './files/investmentcatalog/' . $image_data;
	...
	private function set_upload_options() {
        ...
        $config['upload_path'] = './files/investmentcatalog/';
    ...
    function isHome(){
		...
		$this->model->table('ivt_investmentcatalog')->save($id,$array);	
	}
	function ordering(){
		$array = array();
		$id = $this->input->post('id');
