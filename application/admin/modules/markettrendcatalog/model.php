<?php
 class MarkettrendcatalogModel extends CI_Model{
	...
	function saves($array){
		 $check = $this->model->table('ivt_markettrendcatalog')
		 ->select('id')
		 ->where('isdelete',0)
	...
	function edits($array,$id){
		 ...
		 unset($array['fromdate']);
                 unset($array['todate']);
		 $result = $this->model->table('ivt_markettrendcatalog')->save($id,$array);	
		 return $result;
	}
